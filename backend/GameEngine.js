...
class GameEngine {
    ...
    getExpForLevel(level) {
        // 经验表：从 Lv.N 升到 Lv.N+1 所需经验
        const expTable = [
            0, 33, 76, 132, 202, 286, 386, 503, 637, 791,           // 1-10
            964, 1159, 1377, 1620, 1891, 2192, 2525, 2893, 3300, 3750,  // 11-20
            4247, 4795, 5400, 6068, 6805, 7618, 8517, 9508, 10604, 11814, // 21-30
            13151, 14629, 16262, 18068, 20064, 22271, 24712, 27411, 30396, 33697, // 31-40
            37346, 41381, 45842, 50773, 56222, 62243, 68895, 76242, 84355, 93311, // 41-50
            103195, 114100, 126127, 139390, 154009, 170118, 187863, 207403, 228914, 252584, // 51-60
            278623, 307256, 338731, 373318, 411311, 453030, 498824, 549074, 604193, 664632, // 61-70
            730881, 803472, 882985, 970050, 1065351, 1169633, 1283701, 1408433, 1544780, 1693774, // 71-80
            1856536, 2034279, 2228321, 2440088, 2671127, 2923113, 3197861, 3497335, 3823663, 4179145, // 81-90
            4566274, 4987741, 5446463, 5945587, 6488521, 7078945, 7720834, 8418485, 9176537, 10000000, // 91-100
            11404976, 12904567, 14514400, 16242080, 18095702, 20083886, 22215808, 24501230, 26950540, 29574787, // 101-110
            32385721, 35395838, 38618420, 42067584, 45758332, 49706603, 53929328, 58444489, 63271179, 68429670, // 111-120
            73941479, 79829440, 86117783, 92832214, 100000000, 114406130, 130118394, 147319656, 166147618, 186752428, // 121-130
            209297771, 233962072, 260939787, 290442814, 322702028, 357968938, 396517495, 438646053, 484679494, 534971538, // 131-140
            589907252, 649905763, 715423218, 786955977, 865044093, 950275074, 1043287971, 1144777804, 1255500373, 1376277458, // 141-150
            1508002470, 1651646566, 1808265285, 1979005730, 2165114358, 2367945418, 2588970089, 2829786381, 3092129857, 3377885250, // 151-160
            3689099031, 4027993033, 4396979184, 4798675471, 5235923207, 5711805728, 6229668624, 6793141628, 7406162301, 8073001662, // 161-170
            8798291902, 9587056372, 10444742007, 11377254401, 12390995728, 13492905745, 14690506120, 15991948361, 17406065609, 18942428633, // 171-180
            20611406335, 22424231139, 24393069640, 26531098945, 28852589138, 31372992363, 34109039054, 37078841860, 40302007875, 43799759843, // 181-190
            47595067021, 51712786465, 56179815564, 61025256696, 66280594953, 71979889960, 78159982881, 84860719814, 9225192822, 100000000000  // 191-200
        ];
        
        // 等级从1开始，数组索引从0开始
        const index = level - 1;
        if (index >= 0 && index < expTable.length) {

...
function openPenForgeModal(penId) {
    ...
    modal.innerHTML = `
        <div class="action-detail-popup">
            ...
            <!-- 标题行 -->
            <div class="popup-header-row">
                <div class="popup-icon-large">${pen.icon}</div>
                <div class="popup-name-large">${pen.name}</div>
            </div>
...
const ITEM_VALUES = {
    ...
    brews: {
        ...
        beginner_wine_box: 1120, intermediate_wine_box: 3720, advanced_wine_box: 7480
    },
    // 工具（非锤子）
    tools_normal: {
        ...
        <div class="action-detail-popup">
            ...
            <div class="popup-info-rows">
                ...
                <div class="popup-info-row">
                    ...
                    <div class="popup-info-val">
                        <span class="popup-token-prefix">1</span> 
                        <span class="popup-badge token item-hover-card" data-item-id="${{WOODCUTTING:'wood_token',MINING:'mining_token',GATHERING:'gathering_token',CRAFTING:'crafting_token',CRAFTING_FEATHER:'crafting_token',CRAFTING_MANUSCRIPT:'crafting_token',FORGING:'forging_token',TAILORING:'tailoring_token',TAILORING_THREAD:'tailoring_token',ALCHEMY:'alchemy_token',BREWING:'brewing_token',ESSENCE:'alchemy_token'}[pendingAction.type]}" data-item-type="TOKEN" data-item-name="${{WOODCUTTING:'伐木',MINING:'挖矿',GATHERING:'采集',CRAFTING:'制作',CRAFTING_FEATHER:'制作',CRAFTING_MANUSCRIPT:'制作',FORGING:'锻造',TAILORING:'缝制',TAILORING_THREAD:'缝制',ALCHEMY:'炼金',BREWING:'酿造',ESSENCE:'炼金'}[pendingAction.type]}代币" data-item-icon="🪙">${{WOODCUTTING:'🪓',MINING:'⛏️',GATHERING:'🌿',CRAFTING:'🪵',CRAFTING_FEATHER:'🪵',CRAFTING_MANUSCRIPT:'🪵',FORGING:'🔨',TAILORING:'🧵',TAILORING_THREAD:'🧵',ALCHEMY:'⚗️',BREWING:'🍺',ESSENCE:'⚗️'}[pendingAction.type]} ${{WOODCUTTING:'伐木',MINING:'挖矿',GATHERING:'采集',CRAFTING:'制作',CRAFTING_FEATHER:'制作',CRAFTING_MANUSCRIPT:'制作',FORGING:'锻造',TAILORING:'缝制',TAILORING_THREAD:'缝制',ALCHEMY:'炼金',BREWING:'酿造',ESSENCE:'炼金'}[pendingAction.type]}代币</span>
